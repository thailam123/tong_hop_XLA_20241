...
class CombinedApp:
    ...
    def create_filter_widgets(self):
        ...
        filter_widgets['kernel_size_scale'] = Scale(self.root, from_=1, to=21, orient=tk.HORIZONTAL, label="Kernel Size (Odd Only)")
    ...
    def apply_morphology(self):
        ...
        _, binary_image = cv2.threshold(self.img, self.morph_widgets['threshold_slider'].get(), 255, cv2.THRESH_BINARY)
